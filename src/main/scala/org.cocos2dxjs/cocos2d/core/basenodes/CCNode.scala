...
trait t_ccNode extends t_ccClass {
  ...
  def setPosition(newPosOrxValue:ccPoint | Float, yValue:Float):Unit = js.native
  def setNormalizedPosition(posOrX:ccPoint | Float, y:Float):Unit = js.native
  ...
  def setAnchorPoint(point:ccPoint | Float, y:Float):Unit = js.native
  def getAnchorPointInPoints:ccPoint = js.native
  def getContentSize:ccSize = js.native
  def setContentSize(size:ccSize | Float, height:Float):Unit = js.native
  ...
  def addChild(child:ccNode, localZOrder:Float, tag:Float | String):Unit = js.native
  ...
  def removeComponent(component:String | ccComponent):Unit = js.native
