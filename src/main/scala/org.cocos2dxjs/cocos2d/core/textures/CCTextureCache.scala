...
trait ts_cctextureCache extends js.Object {
  ...
  def cacheImage(path:String, texture:js.Dynamic | js.Dynamic | js.Dynamic):Unit = js.native
  def addUIImage(image:js.Dynamic | js.Dynamic, key:String):ccTexture2D = js.native
