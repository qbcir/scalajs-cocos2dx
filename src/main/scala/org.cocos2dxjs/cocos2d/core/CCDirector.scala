...
import org.cocos2dxjs.cocos2d.core.platform.{ccColor, ccEGLView, t_ccColor, t_ccEGLView}

@js.native
trait t_ccDirector extends js.Object {
  def calculateDeltaTime():Unit = js.native
  def convertToGL(uiPoint:t_ccPoint):ccPoint = js.native
  ...
  def pushScene(scene:t_ccScene):Unit = js.native
  def runScene(scene:t_ccScene):Unit = js.native
