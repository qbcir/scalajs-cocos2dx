...
trait t_ccParticleBatchNode extends t_ccParticleSystem {
  ...
  def initWithTexture(texture:ccTexture2D | js.Dynamic | js.Dynamic, capacity:Float):Boolean = js.native
...
class ccParticleBatchNode(fileImage:String | ccTexture2D, capacity:Float) extends t_ccParticleBatchNode {
}
