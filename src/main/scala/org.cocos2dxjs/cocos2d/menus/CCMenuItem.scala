...
class ccMenuItem(callback:String|js.Function, target:t_ccNode) extends t_ccMenuItem {
}
...
class ccMenuItemLabel(label:t_ccNode, selector:String|js.Function, target:t_ccNode) extends t_ccMenuItemLabel {
}
...
trait t_ccMenuItemAtlasFont extends t_ccMenuItemLabel {
  def initWithString(value:String, charMapFile:String, itemWidth:Float, itemHeight:Float, startCharMap:String, callback:String|js.Dynamic|js.Function, target:js.Dynamic|t_ccNode):Boolean = js.native
}
...
class ccMenuItemAtlasFont(value:String, charMapFile:String, itemWidth:Float, itemHeight:Float, startCharMap:String, callback:String|js.Dynamic|js.Function, target:js.Dynamic|t_ccNode) extends t_ccMenuItemAtlasFont {
}
...
class ccMenuItemFont(value:String, callback:String|js.Function, target:t_ccNode) extends t_ccMenuItemFont {
}
...
class ccMenuItemSprite(normalSprite:js.Dynamic, selectedSprite:js.Dynamic, three:js.Dynamic|t_ccNode, four:String|js.Dynamic|js.Function|t_ccNode, five:String|js.Dynamic|js.Function) extends t_ccMenuItemSprite {
}
...
trait t_ccMenuItemImage extends t_ccMenuItemSprite {
  ...
  def initWithNormalImage(normalImage:Null|String, selectedImage:Null|String, disabledImage:Null|String, callback:Null|String|js.Function, target:Null|t_ccNode):Boolean = js.native
}
...
class ccMenuItemImage(normalImage:Null|String, selectedImage:Null|String, disabledImage:Null|String, callback:Null|String|js.Function, target:Null|t_ccNode) extends t_ccMenuItemImage {
}
