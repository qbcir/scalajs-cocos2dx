...
trait t_ccTransitionSceneOriented extends t_ccTransitionScene {
  def initWithDuration(t:Float, scene:ccScene, orientation:Float | Float | Float | Float):Boolean = js.native
}
...
class ccTransitionSceneOriented(t:Float, scene:ccScene, orientation:Float | Float | Float | Float) extends t_ccTransitionSceneOriented {
  var _className: js.Dynamic = js.native
}
...
trait t_ccTransitionSlideInL extends t_ccTransitionScene {
  ...
  def easeActionWithAction(action:ccActionInterval):js.Dynamic = js.native
}
...
class ccTransitionFade(t:Float, scene:ccScene, o:Float | Float | Float | Float) extends t_ccTransitionFade {
  var _className: js.Dynamic = js.native
}
...
trait t_ccTransitionFadeTR extends t_ccTransitionScene {
  override def onEnter():Unit = js.native
  def easeActionWithAction(action:ccActionInterval):ccActionInterval = js.native
  def actionWithSize(size:ccSize):js.Dynamic = js.native
}
...
trait t_ccTransitionFadeBL extends t_ccTransitionFadeTR {
  override def actionWithSize(size:ccSize):js.Dynamic = js.native
}
